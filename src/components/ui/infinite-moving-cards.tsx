  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px] bg-white shadow-lg"
            style={{
          ...
          >
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <img
                  className="w-10 h-10 rounded-full ml-auto object-cover"
                  src={item.avatar}
                  alt={item.name}
                />
              </div>
